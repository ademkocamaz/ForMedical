    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctor', models.CharField(blank=True, max_length=100, null=True, verbose_name='Doktor Adı / Soyadı')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cvp_catheter', models.DateTimeField(blank=True, null=True, verbose_name='Takılma / Açılma - CVP Kateteri - Tarih/Saat')),
                ('peripheral_catheter', models.DateTimeField(blank=True, null=True, verbose_name='Takılma / Açılma - Periferik Kateter - Tarih/Saat')),
                ('urinary_catheter', models.DateTimeField(blank=True, null=True, verbose_name='Takılma / Açılma - NG Sonda - Tarih/Saat')),
            ],
        ...
        migrations.CreateModel(
            name='ObservationPageOneDetails',
            fields=[
                ('observationdetail_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='form.observationdetail')),
                ('date', models.DateTimeField(verbose_name='Tarih/Saat')),
        ...
        migrations.CreateModel(
            name='ObservationPageTwoDetails',
            fields=[
                ('observationdetail_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='form.observationdetail')),
                ('oral_care', models.DateTimeField(blank=True, null=True, verbose_name='Hijyen - Ağız Bakımı - Tarih/Saat')),
                ('hand_facial_care', models.DateTimeField(blank=True, null=True, verbose_name='Hijyen - El/Yüz Bakımı - Tarih/Saat')),
                ('body_bath', models.DateTimeField(blank=True, null=True, verbose_name='Hijyen - Vücut Banyosu - Tarih/Saat')),
                ('perineal_care', models.DateTimeField(blank=True, null=True, verbose_name='Hijyen - Perine Bakımı - Tarih/Saat')),
                ('toenail_care', models.DateTimeField(blank=True, null=True, verbose_name='Hijyen - Ayak/Tırnak Bakımı - Tarih/Saat')),
                ('dressing_change', models.DateTimeField(blank=True, null=True, verbose_name='Hijyen - Pansuman Değişimi - Tarih/Saat')),
            ],
            bases=('form.observationdetail',),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('observationdetail_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='form.observationdetail')),
                ('planning', models.DateTimeField(verbose_name='Planlama - Tarih/Saat')),
