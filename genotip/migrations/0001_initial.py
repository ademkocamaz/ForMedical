# Generated by Django 4.2.6 on 2023-10-17 14:20

from django.db import migrations, models
import genotip.model.user
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('objects', genotip.model.user.UserManager()),
            ],
        ),
        migrations.CreateModel(
            name='Patient',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('toplam_yatak_sayi', models.SmallIntegerField(blank=True, db_column='TOPLAM_YATAK_SAYI', null=True, verbose_name='Toplam Yatak Sayısı')),
                ('toplam_kuvoz_sayi', models.SmallIntegerField(blank=True, db_column='TOPLAM_KUVOZ_SAYI', null=True, verbose_name='Toplam Küvöz Sayısı')),
                ('toplam_vent_sayi', models.SmallIntegerField(blank=True, db_column='TOPLAM_VENT_SAYI', null=True, verbose_name='Toplam Vent Sayısı')),
            ],
            options={
