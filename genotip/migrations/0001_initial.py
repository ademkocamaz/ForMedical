...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.IntegerField(db_column='ID', primary_key=True, serialize=False)),
                ('servis_adi', models.CharField(db_column='SERVIS_ADI', max_length=50, verbose_name='Servis')),
                ...
                ('durum', models.CharField(blank=True, db_column='DURUM', max_length=10, null=True, verbose_name='Durum')),
            ],
            options={
                'verbose_name': 'Yatak',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.IntegerField(db_column='ID', primary_key=True, serialize=False)),
                ('ad', models.CharField(db_column='AD', max_length=50, verbose_name='Servis Adı')),
