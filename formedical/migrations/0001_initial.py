    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dosyano', models.CharField(db_column='DOSYANO', max_length=15)),
                ('ad', models.CharField(blank=True, db_column='AD', max_length=20, null=True)),
                ('soyad', models.CharField(blank=True, db_column='SOYAD', max_length=20, null=True)),
                ('dogumtarih', models.DateTimeField(blank=True, db_column='DOGUMTARIH', null=True)),
                ('cinsiyet', models.CharField(blank=True, db_column='CINSIYET', max_length=5, null=True)),
                ('vatandaslikno', models.CharField(blank=True, db_column='VATANDASLIKNO', max_length=50, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, to='formedical.patient')),
            ],
            options={
